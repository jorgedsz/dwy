...
import { LayoutDashboard, Users, Calendar, Smartphone, Bot, MessageSquare, LogOut } from 'lucide-react';
    ...
    >
      ...
      <nav className="flex-1 p-3 space-y-1 mt-2">
        ...
        <div className="pt-4 pb-1">
          <p className="text-[10px] font-semibold uppercase tracking-wider px-3" style={{ color: '#475569' }}>AI</p>
        </div>
        <NavLink to="/agents" className={linkClass} style={({ isActive }) => linkStyle(isActive)}>
          <Bot size={15} />
          Agents
        </NavLink>
        <NavLink to="/chatbots" className={linkClass} style={({ isActive }) => linkStyle(isActive)}>
        ...
        {/* Section divider */}
        <div className="pt-4 pb-1">
          <p className="text-[10px] font-semibold uppercase tracking-wider px-3" style={{ color: '#475569' }}>Schedule</p>
        </div>
        <NavLink to="/meetings" className={linkClass} style={({ isActive }) => linkStyle(isActive)}>
          <Calendar size={15} />
          Meetings
        </NavLink>
